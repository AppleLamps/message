...
export default function Home() {
  ...
  return (
    <ChatLayout>
      ...
      <div className="flex-1 overflow-y-auto px-3 pt-1 pb-3 space-y-2 bg-[hsl(var(--ios-system-gray-6))]">
        {messages.length === 0 && (
            ...
            <div key={msg.id} className="flex flex-col">
              {showDateHeader && (
                <div className="text-center py-3">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 text-[12px] text-gray-600 border border-black/5 shadow-sm">
                    <span>iMessage</span>
                    <span className="text-gray-500">•</span>
                    <span>{dateGroup} at {timeString}</span>
                  </div>
                </div>
              )}
